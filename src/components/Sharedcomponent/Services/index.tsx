...
const ServiceCard = ({ isSpace }: { isSpace: boolean }) => {
  return (
    <section
      className={`bg-PowderBlue ${
        isSpace ? "lg:py-24 py-16" : "lg:pb-24 pb-16"
      } dark:bg-darklight`}
    >
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
        <h2 className="pb-16 md:text-[35px] leading-[2.87rem] text-2xl text-midnight_text font-bold dark:text-white">
          Highly innovative
          <br />
          technology & services
        </h2>
        ...
        <div className="pt-11">
          <Link
            href="#"
            className="bg-transparent border border-primary text-primary px-6 py-4 rounded-lg hover:bg-blue-600 hover:text-white"
          >
            View More
          </Link>
        </div>
